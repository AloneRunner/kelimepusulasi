...
const food = prepareList([
  ...
  "adana kebap", "aşure", "ayran",
  "baklava", "beyti", "börek", "bisküvi", "bulgur",
  "cacık", "cheesecake", "çiğ köfte", "çorba", 
  "döner", "dolma", "dürüm",
  "ekmek", "erişte", "ezogelin",
  "güllaç", "gözleme",
  "hamburger", "hamsi tava", "helva", "hoşaf",
  "içli köfte", "imam bayıldı", "iskender",
  "kadayıf", "kahve", "karnıyarık", "kebap", "keşkek", "kısır", "köfte", "kruvasan", "künefe", "kuru fasulye",
  "lahmacun", "lokma",
  "magnolia", "makarna", "mantı", "menemen", "muhallebi", "mücver",
  "noodle",
  "omlet", "öğlen",
  "pasta", "pekmez", "pişi", "pizza", "pilav", "pide", "poğaça",
  "reçel", "revani",
  "salata", "sarma", "simit", "soda", "sucuk", "sushi", "sütlaç", "süt",
  "taco", "tahin", "tarhana", "tost", "traliçe", "türlü",
  "waffle",
  "yoğurt", "yumurta"
]);

const objects = prepareList([
  "abajur", "akvaryum", "albüm", "anahtar", "ampul", "ansiklopedi", "armatür", "askı", "aspiratör", "ataş", "ayakkabı", "ayna",
  "balkon", "balta", "bank", "bant", "bardak", "basamak", "baston", "battaniye", "bavul", "bayrak", "beşik", "bıçak", "biblo", "bilezik", "bilgisayar", "bilye", "bohça", "boru", "bozukluk", "bulaşık", "bülten", "büyüteç",
  "cetvel", "cezve", "cımbız", "cüzdan",
  "çadır", "çakmak", "çan", "çanta", "çarşaf", "çatal", "çekiç", "çelenk", "çerçeve", "çeşme", "çivi", "çöp kutusu", "çorap",
  "damacana", "davul", "defter", "demir", "deterjan", "diş fırçası", "dizüstü", "dolap", "dosya", "düğme", "dürbün", "dümen",
  "eldiven", "elek", "elbise", "etiket",
  "fener", "fırça", "fırın", "fıç", "fiş", "fincan", "flama", "folyo",
  "gazete", "gitar", "gözlük", "gömlek",
  "halat", "halı", "harita", "hatıra", "havlu", "heykel", "hesap makinesi", "hortum", "huni",
  "ızgara",
  "ibrik", "iğne", "ilaç", "imza", "iplik", "iskambil",
  "jelatin", "jilet", "jeton",
  "kablo", "kadeh", "kağıt", "kalem", "kalıp", "kamera", "kamçı", "kanepe", "kapı", "karyola", "kasa", "kase", "kaşık", "kavanoz", "kazan", "kazma", "kilit", "kiremit", "kitap", "klavye", "koltuk", "kova", "kristal", "kulaklık", "kumbara", "kupa", "kutu", "küpe", "kürek",
  "lamba", "lastik", "lavabo", "levha",
  "madalya", "makas", "makara", "mandal", "masa", "maske", "matkap", "mektup", "mendil", "merdiven", "mermer", "meşale", "mikrofon", "minder", "muşamba", "mum", "musluk", "mühür",
  "nargile", "not defteri",
  "ocak", "olta", "oyuncak",
  "önlük", "örtü",
  "paket", "pano", "pantolon", "para", "parfüm", "paslanmaz", "paspas", "peçete", "pense", "perde", "pergel", "pil", "pipo", "plaket", "poşet", "priz", "projektör", "puset",
  "radyo", "raf", "raptiye", "rende", "resim", "roman", "rozet", "ruj",
  "saat", "sabun", "sac", "saç kurutma", "sandalye", "sandık", "saksı", "sargı", "sepet", "sehpa", "silgi", "silikon", "süpürge", "sünger", "sürahi", "süzgeç",
  "şampuan", "şapka", "şemsiye", "şerit", "şişe", "şövale",
  "tabak", "tablo", "tabure", "takvim", "tarak", "tava", "tebeşir", "telefon", "telsiz", "tencere", "tepsi", "terazi", "terlik", "termos", "tesbih", "testere", "teyp", "top", "toplu iğne", "torba", "tornavida", "törpü", "tuğla", "tuzluk", "tütsü",
  "uçurtma", "uyku tulumu",
  "ütü",
  "vazo", "vantilatör", "valiz", "varil", "vida", "vitrin",
  "yastık", "yapıştırıcı", "yelpaze", "yorgan", "yüzük",
  "zımba", "zımpara", "zil", "zincir", "zar", "zarf"
]);

const professions = prepareList([
  "acente", "aktör", "aktris", "analist", "animatör", "antrenör", "arkeolog", "astronot", "astronom", "aşçı", "avukat", "ayakkabıcı",
  "bahçıvan", "bakan", "bakkal", "balıkçı", "bankacı", "barmen", "başbakan", "berber", "besteci", "bilim insanı", "bilgisayarcı", "biyolog", "boyacı", "börekçi",
  "can kurtaran", "cerrah",
  "çaycı", "çevirmen", "çiftçi", "çiçekçi", "çizimci", "çoban", "çömlekçi",
  "dadı", "danışman", "dansçı", "dedektif", "demirci", "denizci", "diş hekimi", "diyetisyen", "doktor", "doçent",
  "eczacı", "editör", "eğitmen", "ekonomist", "elektrikçi", "emlakçı", "esnaf",
  "fabrikatör", "fırıncı", "fizikçi", "fotoğrafçı", "futbolcu",
  "gardiyan", "garson", "gazeteci", "gemici", "general", "genetikçi", "gözlükçü", "grafiker", "güvenlik",
  "hakem", "hakim", "hamal", "hattat", "hemşire", "heykeltıraş", "hizmetli", "hostes", "hukukçu",
  "imam", "insan kaynakları", "inşaatçı", "istatistikçi", "işçi", "işletmeci", "itfaiyeci",
  "jeolog", "jinekolog",
  "kabin memuru", "kameraman", "kamu personeli", "kapıcı", "kaptan", "kardiyolog", "karikatürist", "kasap", "kasiyer", "katip", "kaymakam", "kimyager", "komiser", "konsolos", "koruma", "kurye", "kuaför", "kuyumcu",
  "laborant", "lastikçi", "lokantacı",
  "madenci", "makinist", "mali müşavir", "manav", "manken", "marangoz", "masör", "matbaacı", "memur", "menajer", "meteorolog", "mimar", "mobilyacı", "moda tasarımcısı", "muabir", "muasebeci", "muhtar", "müezzin", "müfettiş", "mühendis", "mütercim", "müzisyen", "müdür",
  "nakliyeci", "noter",
  "operatör", "orman mühendisi", "oyuncu", "ozan",
  "öğretmen", "öğrenci", "öğretim görevlisi",
  "palyaço", "pazarlamacı", "pilot", "piyanist", "polis", "politikacı", "postacı", "profesör", "programcı", "psikolog", "psikiyatrist",
  "radyocu", "rehber", "reklamcı", "rektör", "ressam", "resepsiyonist",
  "saatçi", "sanatçı", "sanayici", "savcı", "sekreter", "seramikçi", "sigortacı", "sihirbaz", "simitçi", "sistem yöneticisi", "sosyolog", "spiker", "sporcu", "stajyer", "stilist", "sunucu", "su tesisatçısı",
  "şair", "şarkıcı", "şef", "şoför",
  "tarihçi", "tasarımcı", "taşeron", "teknisyen", "tekniker", "terzi", "tezgahtar", "terapist", "tercüman", "tesisatçı", "tiyatrocu", "tornacı", "tuhafiyeci", "turizmci",
  "usta", "uzman",
  "vali", "veteriner", "veznedar", "videocu",
  "yargıç", "yazar", "yazılımcı", "yönetici", "yönetmen", "youtuber",
  "zabıta", "zanaatkar", "ziraat mühendisi", "zoolog"
]);
...
const history = prepareList([
  "abide", "anıt", "anlaşma", "antik", "arkeoloji", "asır", 
  "barış", "beylik", "bizans", 
  "cephe", "cumhuriyet", 
  "çağ", 
  "devlet", "devrim", "donanma", 
  "efsane", "emperyalizm", 
  "fetih", "firavun", 
  "gladyatör", "göçebe", 
  "hakan", "hanedan", "harb", "hiyeroglif", "hükümdar", 
  "imparator", "istiklal", "isyan", 
  "kale", "keşif", "kral", "kronoloji", 
  "laiklik", "lozan", 
  "medeniyet", "meclis", "milli mücadele", "monarşi", "müze", 
  "osmanlı", 
  "padişah", "papirüs", "piramit", 
  "sadrazam", "saray", "savaş", "selçuklu", "sömürge", "sultan", "sümer", 
  "tarih", "tbmm", "tuğra", 
  "uygarlık", 
  "vezir", 
  "yazıt", "yeniçeri", "yüzyıl", 
  "zafer", "zırh"
]);
...
const mathTerms = prepareList([
  ...
  "parabol", "paralel", "parantez", "pay", "payda", "pergel", "permütasyon", "piramit", "pi", "polinom", "pozitif", "prizma", "problem",
  "rakam", "rasyonel", "reel",
