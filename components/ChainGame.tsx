...
const ChainGame: React.FC<ChainGameProps> = ({ category, onWin, onLose, onBack, useGameKeyboard = true }) => {
    ...
    <div className="flex flex-col h-full bg-slate-100">
      ...
      <div className="bg-white border-t border-slate-200">
        ...
        {useGameKeyboard ? (
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="p-3">
            <div className="flex gap-2">
              <input
                ...
                placeholder="Kelime türet..."
                disabled={turn === 'bot'}
                className="flex-1 bg-white border-2 border-slate-300 rounded-xl px-4 py-3 text-slate-800 font-medium text-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50"
                autoComplete="off"
                autoCorrect="off"
                spellCheck="false"
                autoCapitalize="none"
              ...
              <button
                ...
                className="px-6 py-3 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
                Gönder
              </button>
            </div>
