...
const ResultModal: React.FC<ResultModalProps> = ({ word, guessCount, earnedCoins, isWin, onReset, onNextLevel, onChangeCategory }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full text-center relative overflow-hidden">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              onClick={isWin && onNextLevel ? onNextLevel : onReset}
            ...
            >
              {isWin ? 'Sonraki Seviye ➡' : 'Tekrar Dene'}
            </button>
          </div>
