  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 relative">
       ...
       <header className="flex items-center justify-between p-4 bg-orange-500 text-white shadow-md z-20">
        ...
        <button 
          onClick={buyHint} 
          className="p-2 bg-yellow-400 hover:bg-yellow-300 text-orange-900 rounded-full shadow-md w-10 h-10 flex flex-col items-center justify-center transition active:scale-95"
        >
