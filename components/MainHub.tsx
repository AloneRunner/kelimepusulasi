...
const MainHub: React.FC<MainHubProps> = ({ 
  ...
  return (
    <div className={`flex flex-col h-full ${styles.container} transition-colors duration-500`}>
      {/* Header */}
      <header className={`p-6 flex justify-between items-center ${activeTheme === 'theme_dark' ? 'bg-slate-800' : 'bg-white'} shadow-sm z-10 sticky top-0 transition-colors duration-500`}>
        <div>
